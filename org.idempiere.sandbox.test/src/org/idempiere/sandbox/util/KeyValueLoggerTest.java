 ...
 *
 * Copyright (C) 2024 iDempiere DevOps and contributors (see README.md file).
 */

package org.idempiere.sandbox.util;

import static org.idempiere.sandbox.test.util.RandomTestUtil.*;
import static org.idempiere.sandbox.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"org.idempiere.sandbox.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"org.idempiere.sandbox.util\"");
	}
